...
export const home: HomeContent = {
  ...
  values: [
    ...
    },
    {
      ...
      icon: 'private',
      label: 'গোপনীয়তা',
      heading: 'আপনার লেখা বাইরে যায় না',
      body: 'অ্যাকাউন্ট নেই, সিংক নেই, সার্ভার নেই। ফ্লাইট মোডেও পুরোটা চলে।',
    },
    {
      id: 'free',
      icon: 'free',
      label: 'ফ্রি',
      heading: 'ফ্রি, আর খোলা',
      body: 'দাম নেই, বিজ্ঞাপন নেই, আপগ্রেড করার কিছু নেই। পুরোটাই এমআইটি লাইসেন্সে।',
    },
  ],
  ...
  */
  ...
  avro: {
    ...
    body: [
      'অভ্র নিজের ভাষা নিজের চেনা বর্ণে লেখাটাকে স্বাভাবিক করে দিয়েছিল, আর তাতে খরচ লাগেনি। ওর স্কিমই একসময় হয়ে উঠেছে বাংলা টাইপ করা বলতে মানুষ যা বোঝে। অবাধ সেই অভ্যাসগুলো হুবহু রাখে — একই স্বর, একই যুক্তাক্ষর, হাতের একই অভ্যাস।',
      'নতুন যা, তা ভেতরে — আর লেখার সময় যেমন লাগে, তাতে।',
    ],
