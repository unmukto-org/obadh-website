  ...
  bento: {
    ...
    tiles: [
      ...
      },
      {
        ...
        body: 'শব্দ লিখলেই তার ইমোজি পরামর্শের সারিতে আসে।',
      },
      {
        id: 'offline',
        heading: 'পুরোটাই চলে ডিভাইসে',
        body: 'লেখা তৈরি, সংশোধন আর পরামর্শ, সবই চলে ইন্টারনেট ছাড়া।',
      },
    ],
    phone: {
    ...
    rows: [
      {
        ...
        line: 'iOS ও iPadOS 18 বা তার পরে',
      },
      {
        name: 'ম্যাক',
        state: 'shipping',
        stateLabel: 'পাওয়া যাচ্ছে',
        line: 'macOS 15 বা তার পরে',
      },
      {
        name: 'লিনাক্স',
        state: 'building',
